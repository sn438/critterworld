...
public class Tokenizer implements Iterator<Token>
{
	...
	/** BufferedReader to read from the {@code Reader} provided in the constructor, not {@code null}. */
	...
	/** The most recent token processed by this Tokenizer, or an error token. Not {@code null}. */
	private Token curTok;

	/** {@code false} if the EOF has not been encountered, {@code true} if it has been encountered */
	 ...
	 * @throws IOException if an IOException was thrown while trying to read from the source Reader
	 * @throws EOFException if EOF was encountered while trying to lex the next token
	 */
	 ...
	 * @throws EOFException if EOF is encountered and a token cannot be produced.
	 */
	 ...
	 *
	 * @throws IOException if an IOException is encountered while reading from the source Reader
	 * @throws EOFException if EOF is encountered and a token cannot be produced.
	 */
	...
	/**
	 * Lexes an identifier. May be called only when the previously read character is a letter.
	 * 
	 * @throws IOException if an IOException was thrown when trying to read from the source Reader
	 * @throws EOFException if EOF is encountered and a token cannot be produced.
	 */
	...
	/**
	 * Lexes a number. May be called only when the previously read character is a digit.
	 * 
	 * @throws IOException if an IOException was thrown when trying to read from the source Reader
	 * @throws EOFException if EOF is encountered and a token cannot be produced.
	 */
	 ...
	 * @throws IOException if an IOException was thrown when trying to read the next char
	 ...
	 *
	 * @param exceptionOnEOF {@code true} if EOF should be treated as an error
	 * @return The integer representation of the next character
	 * @throws IOException if an {@code IOException} is thrown when trying to read from the source Reader
	 * @throws EOFException if EOF is encountered and isEOFerror is true
	 */
	...
	/**
	 * Sets the next token to be a token of {@code tokenType} and clears the {@code StringBuilder}.
	 * @param tokenType - the type of the token to set, not {@code null}
	 */
	 ...
	 * 
	 * @param tokenType - the type of the token to set, not {@code null}
	 * @param c - the character to use at the start of the string builder
	 */
	 ...
	 * @param c - the character with which to start a new string
	 */
	...
	/** Makes the current token an error token with the current contents of the buffer. */
