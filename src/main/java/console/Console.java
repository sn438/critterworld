...
public class Console
{
	...
	/**
	 * Loads critter definition from filename and randomly places n critters with that definition into the world.
	 * If the file cannot be found, this method prints an error message and loads 0 critters. If the file contains
	 * invalid attributes, critters are supplied with default memory values. A full list of default critter memory
	 * values can be found in our overview document.
	 *
	 * @param filename
	 * @param n
	 */
	...
	private int[] makeCritterAttributes(String[] strs)
	{
		...
		if(memsize < world.getMinMemory())
			memsize = world.getMinMemory();
