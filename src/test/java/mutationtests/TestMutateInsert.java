...
/**
 * 
 * This test class essentially tests the Insert Mutation by applying the Insert Mutation to random nodes 
...
public class TestMutateInsert {
	...
	public void testMutate() {
		...
		for (int i = 0; i < prog.size(); i++)
			...
			try {
				System.out.println(prog.mutate(n, new MutationInsert(true)).toString());
